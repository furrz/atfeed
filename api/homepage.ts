...
<head>
    ...
    <style>
        ...
        a { color: #18438b; text-decoration: none; font-weight: bold; }
    </style>
</head>
<body>
    <h1>Bluesky Feeds</h1>
    ...
    <ul>
        ${serverInfos.map(s => `<li><a href="https://bsky.app/profile/${client.session.did}/feed/${s.rkey}">${s.displayName}</a> - ${s.description}</li>`).join("")}
    </ul>
</body>
</html>
    `);
